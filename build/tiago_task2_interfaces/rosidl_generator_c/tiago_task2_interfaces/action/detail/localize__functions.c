...
tiago_task2_interfaces__action__Localize_Goal__create()
{
  ...
  tiago_task2_interfaces__action__Localize_Goal * msg = (tiago_task2_interfaces__action__Localize_Goal *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tiago_task2_interfaces__action__Localize_Goal));
  bool success = tiago_task2_interfaces__action__Localize_Goal__init(msg);
  if (!success) {
...
tiago_task2_interfaces__action__Localize_Goal__destroy(tiago_task2_interfaces__action__Localize_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tiago_task2_interfaces__action__Localize_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tiago_task2_interfaces__action__Localize_Goal__Sequence__init(tiago_task2_interfaces__action__Localize_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_Goal * data = NULL;

  if (size) {
    data = (tiago_task2_interfaces__action__Localize_Goal *)allocator.zero_allocate(size, sizeof(tiago_task2_interfaces__action__Localize_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tiago_task2_interfaces__action__Localize_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tiago_task2_interfaces__action__Localize_Goal__fini(&data[i - 1]);
      }
...
tiago_task2_interfaces__action__Localize_Goal__Sequence__fini(tiago_task2_interfaces__action__Localize_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tiago_task2_interfaces__action__Localize_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_Goal__Sequence * array = (tiago_task2_interfaces__action__Localize_Goal__Sequence *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tiago_task2_interfaces__action__Localize_Goal__Sequence__init(array, size);
  if (!success) {
...
tiago_task2_interfaces__action__Localize_Goal__Sequence__destroy(tiago_task2_interfaces__action__Localize_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tiago_task2_interfaces__action__Localize_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tiago_task2_interfaces__action__Localize_Goal__Sequence__are_equal(const tiago_task2_interfaces__action__Localize_Goal__Sequence * lhs, const tiago_task2_interfaces__action__Localize_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tiago_task2_interfaces__action__Localize_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tiago_task2_interfaces__action__Localize_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tiago_task2_interfaces__action__Localize_Goal * data =
      (tiago_task2_interfaces__action__Localize_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tiago_task2_interfaces__action__Localize_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tiago_task2_interfaces__action__Localize_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_Result * msg = (tiago_task2_interfaces__action__Localize_Result *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tiago_task2_interfaces__action__Localize_Result));
  bool success = tiago_task2_interfaces__action__Localize_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_Result__destroy(tiago_task2_interfaces__action__Localize_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tiago_task2_interfaces__action__Localize_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tiago_task2_interfaces__action__Localize_Result__Sequence__init(tiago_task2_interfaces__action__Localize_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_Result * data = NULL;

  if (size) {
    data = (tiago_task2_interfaces__action__Localize_Result *)allocator.zero_allocate(size, sizeof(tiago_task2_interfaces__action__Localize_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tiago_task2_interfaces__action__Localize_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tiago_task2_interfaces__action__Localize_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tiago_task2_interfaces__action__Localize_Result__Sequence__fini(tiago_task2_interfaces__action__Localize_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tiago_task2_interfaces__action__Localize_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_Result__Sequence * array = (tiago_task2_interfaces__action__Localize_Result__Sequence *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tiago_task2_interfaces__action__Localize_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_Result__Sequence__destroy(tiago_task2_interfaces__action__Localize_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tiago_task2_interfaces__action__Localize_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tiago_task2_interfaces__action__Localize_Result__Sequence__are_equal(const tiago_task2_interfaces__action__Localize_Result__Sequence * lhs, const tiago_task2_interfaces__action__Localize_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tiago_task2_interfaces__action__Localize_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tiago_task2_interfaces__action__Localize_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tiago_task2_interfaces__action__Localize_Result * data =
      (tiago_task2_interfaces__action__Localize_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tiago_task2_interfaces__action__Localize_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tiago_task2_interfaces__action__Localize_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tiago_task2_interfaces__action__Localize_Feedback__are_equal(const tiago_task2_interfaces__action__Localize_Feedback * lhs, const tiago_task2_interfaces__action__Localize_Feedback * rhs)
{
  ...
  // current_covariance
  if (lhs->current_covariance != rhs->current_covariance) {
    return false;
  }
  return true;
}
  ...
  tiago_task2_interfaces__action__Localize_Feedback * output)
{
  ...
  // current_covariance
  output->current_covariance = input->current_covariance;
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_Feedback * msg = (tiago_task2_interfaces__action__Localize_Feedback *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tiago_task2_interfaces__action__Localize_Feedback));
  bool success = tiago_task2_interfaces__action__Localize_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_Feedback__destroy(tiago_task2_interfaces__action__Localize_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tiago_task2_interfaces__action__Localize_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tiago_task2_interfaces__action__Localize_Feedback__Sequence__init(tiago_task2_interfaces__action__Localize_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_Feedback * data = NULL;

  if (size) {
    data = (tiago_task2_interfaces__action__Localize_Feedback *)allocator.zero_allocate(size, sizeof(tiago_task2_interfaces__action__Localize_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tiago_task2_interfaces__action__Localize_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tiago_task2_interfaces__action__Localize_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tiago_task2_interfaces__action__Localize_Feedback__Sequence__fini(tiago_task2_interfaces__action__Localize_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tiago_task2_interfaces__action__Localize_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_Feedback__Sequence * array = (tiago_task2_interfaces__action__Localize_Feedback__Sequence *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tiago_task2_interfaces__action__Localize_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_Feedback__Sequence__destroy(tiago_task2_interfaces__action__Localize_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tiago_task2_interfaces__action__Localize_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tiago_task2_interfaces__action__Localize_Feedback__Sequence__are_equal(const tiago_task2_interfaces__action__Localize_Feedback__Sequence * lhs, const tiago_task2_interfaces__action__Localize_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tiago_task2_interfaces__action__Localize_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tiago_task2_interfaces__action__Localize_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tiago_task2_interfaces__action__Localize_Feedback * data =
      (tiago_task2_interfaces__action__Localize_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tiago_task2_interfaces__action__Localize_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tiago_task2_interfaces__action__Localize_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tiago_task2_interfaces__action__Localize_SendGoal_Request__init(tiago_task2_interfaces__action__Localize_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    tiago_task2_interfaces__action__Localize_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!tiago_task2_interfaces__action__Localize_Goal__init(&msg->goal)) {
    tiago_task2_interfaces__action__Localize_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
tiago_task2_interfaces__action__Localize_SendGoal_Request__fini(tiago_task2_interfaces__action__Localize_SendGoal_Request * msg)
{
  ...
  // goal
  tiago_task2_interfaces__action__Localize_Goal__fini(&msg->goal);
}
...
tiago_task2_interfaces__action__Localize_SendGoal_Request__are_equal(const tiago_task2_interfaces__action__Localize_SendGoal_Request * lhs, const tiago_task2_interfaces__action__Localize_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!tiago_task2_interfaces__action__Localize_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_SendGoal_Request * msg = (tiago_task2_interfaces__action__Localize_SendGoal_Request *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tiago_task2_interfaces__action__Localize_SendGoal_Request));
  bool success = tiago_task2_interfaces__action__Localize_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence__init(tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_SendGoal_Request * data = NULL;

  if (size) {
    data = (tiago_task2_interfaces__action__Localize_SendGoal_Request *)allocator.zero_allocate(size, sizeof(tiago_task2_interfaces__action__Localize_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tiago_task2_interfaces__action__Localize_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tiago_task2_interfaces__action__Localize_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence__fini(tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tiago_task2_interfaces__action__Localize_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence * array = (tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence__destroy(tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence__are_equal(const tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence * lhs, const tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tiago_task2_interfaces__action__Localize_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tiago_task2_interfaces__action__Localize_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tiago_task2_interfaces__action__Localize_SendGoal_Request * data =
      (tiago_task2_interfaces__action__Localize_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tiago_task2_interfaces__action__Localize_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tiago_task2_interfaces__action__Localize_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tiago_task2_interfaces__action__Localize_SendGoal_Response__init(tiago_task2_interfaces__action__Localize_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    tiago_task2_interfaces__action__Localize_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_SendGoal_Response * msg = (tiago_task2_interfaces__action__Localize_SendGoal_Response *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tiago_task2_interfaces__action__Localize_SendGoal_Response));
  bool success = tiago_task2_interfaces__action__Localize_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence__init(tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_SendGoal_Response * data = NULL;

  if (size) {
    data = (tiago_task2_interfaces__action__Localize_SendGoal_Response *)allocator.zero_allocate(size, sizeof(tiago_task2_interfaces__action__Localize_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tiago_task2_interfaces__action__Localize_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tiago_task2_interfaces__action__Localize_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence__fini(tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tiago_task2_interfaces__action__Localize_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence * array = (tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence__destroy(tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence__are_equal(const tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence * lhs, const tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tiago_task2_interfaces__action__Localize_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tiago_task2_interfaces__action__Localize_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tiago_task2_interfaces__action__Localize_SendGoal_Response * data =
      (tiago_task2_interfaces__action__Localize_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tiago_task2_interfaces__action__Localize_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tiago_task2_interfaces__action__Localize_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tiago_task2_interfaces__action__Localize_GetResult_Request__init(tiago_task2_interfaces__action__Localize_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    tiago_task2_interfaces__action__Localize_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_GetResult_Request * msg = (tiago_task2_interfaces__action__Localize_GetResult_Request *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tiago_task2_interfaces__action__Localize_GetResult_Request));
  bool success = tiago_task2_interfaces__action__Localize_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence__init(tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_GetResult_Request * data = NULL;

  if (size) {
    data = (tiago_task2_interfaces__action__Localize_GetResult_Request *)allocator.zero_allocate(size, sizeof(tiago_task2_interfaces__action__Localize_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tiago_task2_interfaces__action__Localize_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tiago_task2_interfaces__action__Localize_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence__fini(tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tiago_task2_interfaces__action__Localize_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence * array = (tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence__destroy(tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence__are_equal(const tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence * lhs, const tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tiago_task2_interfaces__action__Localize_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tiago_task2_interfaces__action__Localize_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tiago_task2_interfaces__action__Localize_GetResult_Request * data =
      (tiago_task2_interfaces__action__Localize_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tiago_task2_interfaces__action__Localize_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tiago_task2_interfaces__action__Localize_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tiago_task2_interfaces__action__Localize_GetResult_Response__init(tiago_task2_interfaces__action__Localize_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!tiago_task2_interfaces__action__Localize_Result__init(&msg->result)) {
    tiago_task2_interfaces__action__Localize_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
tiago_task2_interfaces__action__Localize_GetResult_Response__fini(tiago_task2_interfaces__action__Localize_GetResult_Response * msg)
{
  ...
  // status
  // result
  tiago_task2_interfaces__action__Localize_Result__fini(&msg->result);
}
...
tiago_task2_interfaces__action__Localize_GetResult_Response__are_equal(const tiago_task2_interfaces__action__Localize_GetResult_Response * lhs, const tiago_task2_interfaces__action__Localize_GetResult_Response * rhs)
{
  ...
  // result
  if (!tiago_task2_interfaces__action__Localize_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_GetResult_Response * msg = (tiago_task2_interfaces__action__Localize_GetResult_Response *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tiago_task2_interfaces__action__Localize_GetResult_Response));
  bool success = tiago_task2_interfaces__action__Localize_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence__init(tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_GetResult_Response * data = NULL;

  if (size) {
    data = (tiago_task2_interfaces__action__Localize_GetResult_Response *)allocator.zero_allocate(size, sizeof(tiago_task2_interfaces__action__Localize_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tiago_task2_interfaces__action__Localize_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tiago_task2_interfaces__action__Localize_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence__fini(tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tiago_task2_interfaces__action__Localize_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence * array = (tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence__destroy(tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence__are_equal(const tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence * lhs, const tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tiago_task2_interfaces__action__Localize_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tiago_task2_interfaces__action__Localize_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tiago_task2_interfaces__action__Localize_GetResult_Response * data =
      (tiago_task2_interfaces__action__Localize_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tiago_task2_interfaces__action__Localize_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tiago_task2_interfaces__action__Localize_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tiago_task2_interfaces__action__Localize_FeedbackMessage__init(tiago_task2_interfaces__action__Localize_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    tiago_task2_interfaces__action__Localize_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!tiago_task2_interfaces__action__Localize_Feedback__init(&msg->feedback)) {
    tiago_task2_interfaces__action__Localize_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
tiago_task2_interfaces__action__Localize_FeedbackMessage__fini(tiago_task2_interfaces__action__Localize_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  tiago_task2_interfaces__action__Localize_Feedback__fini(&msg->feedback);
}
...
tiago_task2_interfaces__action__Localize_FeedbackMessage__are_equal(const tiago_task2_interfaces__action__Localize_FeedbackMessage * lhs, const tiago_task2_interfaces__action__Localize_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!tiago_task2_interfaces__action__Localize_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_FeedbackMessage * msg = (tiago_task2_interfaces__action__Localize_FeedbackMessage *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tiago_task2_interfaces__action__Localize_FeedbackMessage));
  bool success = tiago_task2_interfaces__action__Localize_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence__init(tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_FeedbackMessage * data = NULL;

  if (size) {
    data = (tiago_task2_interfaces__action__Localize_FeedbackMessage *)allocator.zero_allocate(size, sizeof(tiago_task2_interfaces__action__Localize_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tiago_task2_interfaces__action__Localize_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tiago_task2_interfaces__action__Localize_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence__fini(tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tiago_task2_interfaces__action__Localize_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence * array = (tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence *)allocator.allocate(sizeof(tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence__destroy(tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence__are_equal(const tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence * lhs, const tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tiago_task2_interfaces__action__Localize_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tiago_task2_interfaces__action__Localize_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tiago_task2_interfaces__action__Localize_FeedbackMessage * data =
      (tiago_task2_interfaces__action__Localize_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tiago_task2_interfaces__action__Localize_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tiago_task2_interfaces__action__Localize_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tiago_task2_interfaces__action__Localize_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
