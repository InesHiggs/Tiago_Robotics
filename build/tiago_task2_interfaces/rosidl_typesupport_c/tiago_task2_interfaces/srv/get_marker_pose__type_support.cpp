...
static const _GetMarkerPose_Request_type_support_symbol_names_t _GetMarkerPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tiago_task2_interfaces, srv, GetMarkerPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tiago_task2_interfaces, srv, GetMarkerPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tiago_task2_interfaces, srv, GetMarkerPose_Request)() {
  return &::tiago_task2_interfaces::srv::rosidl_typesupport_c::GetMarkerPose_Request_message_type_support_handle;
}
...
static const _GetMarkerPose_Response_type_support_symbol_names_t _GetMarkerPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tiago_task2_interfaces, srv, GetMarkerPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tiago_task2_interfaces, srv, GetMarkerPose_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tiago_task2_interfaces, srv, GetMarkerPose_Response)() {
  return &::tiago_task2_interfaces::srv::rosidl_typesupport_c::GetMarkerPose_Response_message_type_support_handle;
}
...
static const _GetMarkerPose_type_support_symbol_names_t _GetMarkerPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tiago_task2_interfaces, srv, GetMarkerPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tiago_task2_interfaces, srv, GetMarkerPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tiago_task2_interfaces, srv, GetMarkerPose)() {
  return &::tiago_task2_interfaces::srv::rosidl_typesupport_c::GetMarkerPose_service_type_support_handle;
}
